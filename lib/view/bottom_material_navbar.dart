    ...
    return Scaffold(
      ...
      BottomNavigationBar(
        ...
        items: <BottomNavigationBarItem>[
          BottomNavigationBarItem(icon: Icon(Icons.emoji_emotions), label: AppLocalizations.of(context)!.emotion,),
          BottomNavigationBarItem(icon: Icon(Icons.fastfood), label: AppLocalizations.of(context)!.diet),
          BottomNavigationBarItem(icon: Icon(Icons.run_circle), label: AppLocalizations.of(context)!.workout),
        ],
